...
public class JwtHpler {
    ...
    public static String createAccountJWT(String id,String username,long ttlMillis){
        ...
        JwtBuilder builder = Jwts.builder() //这里其实就是new一个JwtBuilder，设置jwt的body
                ...
                .setSubject(id)        //sub(Subject)：代表这个JWT的主体，即它的所有人，这个是一个json格式的字符串，可以存放什么userid，roldid之类的，作为什么用户的唯一标志。
...
//            builder.setExpiration(exp);     //设置过期时间
    ...
    public static void main(String[] args) throws InterruptedException {
        String jwt = JwtHpler.createAccountJWT("4f5sd4f56sd","nishishui",3000L);
    ...
    public static Claims parseJWT(String jwt) throws ExpiredJwtException {
        SecretKey key = JwtHpler.generalKey();  //签名秘钥，和生成的签名的秘钥一模一样
